<%@ Page language="c#" CodeBehind="DiscussDetails.aspx.cs" AutoEventWireup="false" Inherits="ASPNetPortal.DiscussDetails" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <asp:panel id="ButtonPanel" runat="server"><A class="CommandButton" id="prevItem" title="Previous Message" runat="server">
                                            <IMG src='<%=Request.ApplicationPath + "/images/rew.gif"  %>' border="0"></A>&nbsp; <A class="CommandButton" id="nextItem" title="Next Message" runat="server"><IMG src='<%=Request.ApplicationPath + "/images/fwd.gif"  %>' border="0"></A>&nbsp; 
