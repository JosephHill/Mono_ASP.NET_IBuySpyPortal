<%@ Page Language="c#" Inherits="ASPNetPortal.MobileDefault" CodeBehind="MobileDefault.aspx.cs" AutoEventWireup="false" %>
...
<mobile:Form runat="server" Wrapping="NoWrap" Paginate="true" PagerStyle-Font-Name="Verdana" PagerStyle-ForeColor="#ffffff" PagerStyle-Font-Size="Small" id="Form1">
    ...
    <portal:TabbedPanel id="TabView" runat="server" ActiveTabTextColor="#ffffff" ActiveTabColor="#000000" TabTextColor="#000000" TabColor="#bbbb9a">
    </portal:TabbedPanel>
</mobile:Form>
